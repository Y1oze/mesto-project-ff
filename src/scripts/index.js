...
initialCards.forEach(item => {
  cardContainer.append(createCard(item, deleteCard, likeCard, showImageInPopup));
});
...
function addNewCard(evt) {
  ...
  cardContainer.append(createCard(newCard, deleteCard, likeCard, showImageInPopup));
...
popupNewCardButton.addEventListener('click', () => appearPopup(popupNewCard, popupNewCardCloseButton));